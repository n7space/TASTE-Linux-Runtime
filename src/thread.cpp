...
namespace taste
{
    void InterfaceThread::start(void (*method)())
    {
        ...
        res = pthread_create(&m_thread_id,
							 &thread_attributes,
							 &InterfaceThread::method_wrapper,
	...
	InterfaceThread::InterfaceThread(int priority, size_t stack_size) :
		m_priority(priority),
		m_stack_size(stack_size)
	{
	}

	void* InterfaceThread::method_wrapper(void* param)
	{
